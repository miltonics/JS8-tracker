...
# - UDP listener + WSJT-X packet parser
# - classify_line() event classifier
...
BUILD_TAG = "js8-tracker-phase2-2026-04-05"
...
def upsert_station(con: sqlite3.Connection, callsign: str, event: ParsedEvent, role: str) -> None:
    ...
    if row is None:
        ...
        """, (
            ...
            new_layer, new_conf, new_groups, callsign,
        ))
...
def root() -> dict[str, str]:
    return {
        "name": "JS8-tracker Phase 2 Backend",
        "build_tag": BUILD_TAG,
        "status": "/api/status",
        "events": "/api/events",
